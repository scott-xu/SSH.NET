...
namespace Renci.SshNet.Tests.Classes.Security.Cryptography.Ciphers
{
    ...
    public class AesCipherTest : TestBase
    {
        ...
        public void AES_ECB_128_Length16_NoPad()
        {
            ...
            var actual = new AesCipher(key, iv: null, CipherMode.ECB, pkcs7Padding: false).Encrypt(input);

            CollectionAssert.AreEqual(expected, actual);

            var decrypted = new AesCipher(key, iv: null, CipherMode.ECB, pkcs7Padding: false).Decrypt(actual);
        ...
        public void AES_ECB_128_Length16_Pad()
        {
            ...
            var actual = new AesCipher(key, iv: null, CipherMode.ECB, pkcs7Padding: true).Encrypt(input);

            CollectionAssert.AreEqual(expected, actual);

            var decrypted = new AesCipher(key, iv: null, CipherMode.ECB, pkcs7Padding: true).Decrypt(actual);
        ...
        public void AES_CFB_128_Length16_NoPad()
        {
            ...
            var actual = new AesCipher(key, (byte[])iv.Clone(), CipherMode.CFB, pkcs7Padding: false).Encrypt(input);

            CollectionAssert.AreEqual(expected, actual);

            var decrypted = new AesCipher(key, (byte[])iv.Clone(), CipherMode.CFB, pkcs7Padding: false).Decrypt(actual);
        ...
        public void AES_OFB_128_Length16_NoPad()
        {
            ...
            var actual = new AesCipher(key, (byte[])iv.Clone(), CipherMode.OFB, pkcs7Padding: false).Encrypt(input);

            CollectionAssert.AreEqual(expected, actual);

            var decrypted = new AesCipher(key, (byte[])iv.Clone(), CipherMode.OFB, pkcs7Padding: false).Decrypt(actual);
